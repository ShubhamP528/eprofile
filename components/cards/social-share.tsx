      ...
      <div className="space-y-3">
        {shareLinks.map((link) => (
          <button
            ...
            className={`w-full flex items-center justify-center px-6 py-4 bg-gradient-to-r ${link.gradient} ${link.hoverGradient} text-white rounded-xl transition-all duration-200 shadow-lg hover:shadow-xl transform hover:-translate-y-0.5`}
